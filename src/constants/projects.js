export const allProjects = [
  {
    title: 'Cascade',
    subtitle:
      'A visual canvas for prototyping with live previews, abstracting away git and terminal',
    year: 2026,
    logo: './static/images/cascade.png',
    links: [
      {
        title: 'Site',
        link: 'https://withcascade.com/',
      },
      {
        title: 'Demo',
        link: 'https://x.com/avinashj_/status/1974216862733914550?s=20',
      },
    ],
  },
  {
    title: 'Stagehand',
    subtitle: 'An app to automatically stage and theme rooms from photos in your camera roll',
    logo: './static/images/stagehand.png',
    year: 2025,
    links: [
      {
        title: 'Site',
        link: 'https://withstagehand.com/',
      },
      {
        title: 'Demo',
        link: 'https://x.com/avinashj_/status/1950247676999864598?s=20',
      },
    ],
  },
  {
    title: 'Reframe',
    subtitle: 'UX canvas to draw your own masks and expand your images',
    year: 2025,
    links: [
      {
        title: 'Site',
        link: 'https://expandimage.ai',
      },
      {
        title: 'Demo',
        link: 'https://x.com/johnathanchewy/status/1933917203448959393?s=20',
      },
    ],
  },
  {
    title: 'Orbit',
    subtitle:
      'iOS app to view and share your runs via route overlay on photos taken in camera roll',
    logo: './static/images/orbit.png',
    year: 2025,
    links: [
      {
        title: 'App Store',
        link: 'https://apps.apple.com/us/app/orbit-running/id6526477557',
      },
      {
        title: 'Twitter',
        link: 'https://x.com/avinashj_/status/1945323578209247631?s=20',
      },
    ],
  },
  {
    title: 'Melt Labs',
    subtitle:
      "Automatic video dubbing pipeline to translate courses in any language using the speaker's voice",
    logo: './static/images/melt.png',
    year: 2024,
    links: [
      {
        title: 'Site',
        link: 'https://www.udemy.com/user/avinash-4527/?srsltid=AfmBOoooVVwKNy4qTrEonJRrifmu3BwbuljIfaiKWTEmJO8wtjezOPGc',
      },
    ],
  },
  {
    ...
    links: [
      {
        title: 'Site',
        link: 'https://gumball-ui.vercel.app/',
      },
      {
        title: 'Demo',
        link: 'https://x.com/avinashj_/status/1681160312127463424',
      },
    ],
  },
  {
    ...
    links: [
      {
        title: 'Twitter',
        link: 'https://twitter.com/avinashj_/status/1489080148666159104?s=20',
      },
    ],
  },
  {
